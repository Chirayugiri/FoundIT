...
function FoundReport() {
    ...
    return (
        <div class="flex items-center justify-center min-h-screen foundReport">
            <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-sm">
                ...
                <form method='post' onSubmit={sendData}>
                    <div class="mb-4">
                        <input class="w-full px-3 py-2 border rounded-lg" placeholder="title" type="text" onChange={(e)=> setTitle(e.target.value)} required/>
                    </div>
                    <div class="mb-4">
                        <input class="w-full px-3 py-2 border rounded-lg" placeholder="location" type="text" onChange={(e)=> setLocation(e.target.value)} required/>
                    </div>
                    <div class="mb-4">
                        <textarea class="w-full px-3 py-2 border rounded-lg" id="desc" name="desc" placeholder="Describe here..." onChange={(e)=> setDesc(e.target.value)} required>
                        </textarea>
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        <input class="w-full px-3 py-2 border rounded-lg" type="file" name="file" onChange={(e)=> setFile(e.target.files[0])} required/>
                    </div>
