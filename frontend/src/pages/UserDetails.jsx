...
function UserDetails() {
    ...
    async function sendData(e) { 
        ...
        console.log("Current UID: ", currUserUid);
        ...
        if (!data.uid || !data.email || !data.username || !data.mob || !data.branch || !data.year) {
        ...
        try {
            ...
            if (response.ok && result.message === 'user created') {
                ...
                console.error('Failed to create user:', result.message || 'Unknown error');
            }
        } catch (err) {
    ...
    return (
        <div class="flex items-center justify-center min-h-screen userDetail">
            <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-sm">
                ...
                <form method='post' onSubmit={sendData}>
                    <div class="mb-4">
                        <input class="w-full px-3 py-2 border rounded-lg" placeholder="Name" type="text" onChange={(e)=> setName(e.target.value)} required/>
                    </div>
                    <div class="mb-4">
                        <input class="w-full px-3 py-2 border rounded-lg" placeholder="Mobile" type="text" onChange={(e)=> setMob(e.target.value)} required/>
                    </div>
                    <div class="mb-4">
                        <select class="w-full px-3 py-2 border rounded-lg" id="branch" name="branch" onChange={(e)=> setBranch(e.target.value)} required>
                    ...
                    <div class="mb-4">
                        <select class="w-full px-3 py-2 border rounded-lg" id="year" name="year" onChange={(e)=> setYear(e.target.value)} required>
