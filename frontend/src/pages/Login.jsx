...
function Login() { 
  ...
  return (
    <div class="flex items-center justify-center min-h-screen p-4 login">
      <div class="bg-white py-4 px-6 rounded-lg shadow-lg w-full max-w-sm">
        ...
        <form>
          <div class="mb-3">
            ...
            <input class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="your@email.com" type="email" onChange={(e)=> setEmail(e.target.value)}/>
          </div>
          <div class="mb-3">
            ...
            <input class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="••••••••" type="password" onChange={(e)=> setPass(e.target.value)}/>
          </div>
          ...
          <button class="w-full bg-black text-white py-2 rounded-lg hover:bg-gray-800 transition duration-200" type="submit" onClick={SignInWithEmailPass}>
            Sign In
          </button>
        </form>
        <div class="text-center mt-3">
          <p class="text-gray-700">
            ...
            <span> </span>
            <a class="text-blue-500 hover:underline" href="#" onClick={(e)=> {
              e.preventDefault()
              navigate('/register')
            }}>
              Register
        ...
        <div class="flex items-center my-3">
          ...
          <span class="mx-2 text-gray-500" onClick={()=> localStorage.removeItem("email")}>
            or
          </span>
          <hr class="flex-grow border-gray-300" />
        </div>
        <button class="w-full flex items-center justify-center bg-white border border-gray-300 py-2 rounded-lg hover:bg-gray-100 transition duration-200 mb-2" onClick={signInWithGoogle}>
